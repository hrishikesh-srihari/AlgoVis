...
document.querySelector("#dfs").addEventListener("click",() => makeChoice("Depth-First Search"));
document.querySelector("#bfs").addEventListener("click",() => makeChoice("Breadth-First Search"));
...
document.querySelector("#bidirectional-greedy-bfs").addEventListener("click",() => makeChoice("Bidirectional Greedy Best First Search"));
document.querySelector("#bidirectional-dijkstra").addEventListener("click",() => makeChoice("Bidirectional Dijkstra (UCS)"));
document.querySelector("#greedybest").addEventListener("click",() => makeChoice("Greedy Best First Search"));
